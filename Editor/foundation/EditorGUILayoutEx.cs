...
namespace mulova.switcher.foundation
{
    ...
    public class EditorGUILayoutEx {
        ...
        public static bool PopupFiltered<T>(string label, ref T selection, IList<T> items, ref string filter, params GUILayoutOption[] options) {
            ...
            TextField(null, ref filter, EditorStyles.toolbarTextField);
            ...
            bool changed = PopupNullable<T>(null, ref selection, filtered);
        ...
        public static bool SearchField(string label, ref string str) {
            EditorGUILayout.BeginHorizontal();
            var s = EditorGUILayout.DelayedTextField("", str, new GUIStyle("SearchTextField"));
        ...
        public static bool PopupEnum<T>(string label, ref T selection, IList<T> list, params GUILayoutOption[] options) where T: struct, IComparable, IConvertible, IFormattable {
            return Popup<T>(label, ref selection, list, null, options);
        }
        ...
        */
        public static bool Popup<T>(string label, ref T selection, IList<T> items, GUIStyle style, params GUILayoutOption[] popupOptions) {
            if (items.Count == 0) {
                return false;
            }
            int index = -1;
        ...
        public static bool GameObjectField(string label, ref GameObject obj, bool allowSceneObjects, ref bool floating, params GUILayoutOption[] options) {
            ...
            Toggle(null, ref floating, GUILayout.Width(30));
